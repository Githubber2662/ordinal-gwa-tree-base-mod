addLayer("b", {
    ...
    layerShown(){return player.g.base.lte(10)&&!inAnyChallenge("r")},
  ...
  canReset(){return (player.g.incrementyUnlock?player.b.psi:player.g.points).gte(this.requires()) && (player.g.incrementyUnlock||((player.g.points.lt("e9.99e9") || player.g.base.lte(4)) && !player.b.activeChallenge))},
  onPrestige(){
