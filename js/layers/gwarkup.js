...
addLayer("g", {
    ...
    startData() { return {
      ...
      challengeUnlock: true,
      incrementyUnlock: true,
    }},
    color: "#009696",
  ...
  clickables: {
    ...
    12:{
      ...
      unlocked(){return player.g.base.lte(11)}
    },
  },
  buyables: {
    11: {
      ...
      title: "Base Shift",
        ...
        buy() {
          ...
          player.g.base=player.g.base.add(-1)
  ...
  upgrades: {
    11:{
      ...
      cost(){
        if (player.g.base.eq(11))return new Decimal(144)
        if (player.g.base.eq(10))return new Decimal(160)
    ...
    12:{
      ...
      description(){return "Boost your autoclickers based on unspent GP. Currently: *"+format(this.effect())},
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e100)
        if (player.g.base.eq(10))return new Decimal(1e10)
        if (player.g.base.eq(9))return new Decimal(1e20)
        return new Decimal(100).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,11) || player.g.base.lte(10)},
      effect(){
    ...
    13:{
      ...
      description(){return "Boost your autoclickers based on unspent GP. Currently: *"+format(this.effect())},
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e111)
        if (player.g.base.eq(10))return new Decimal(2e21)
        if (player.g.base.eq(9))return new Decimal(1e23)
        return new Decimal(1000).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,12) || player.g.base.lte(10)},
      effect(){
    ...
    14:{
      ...
      description(){return "Boost your autoclickers based on unspent GP. Currently: *"+format(this.effect())},
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e120)
        if (player.g.base.gt(8))return new Decimal(1e30)
        return new Decimal(1e4).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,13) || player.g.base.lte(10)},
      effect(){
    ...
    15:{
      ...
      description(){return "Boost your autoclickers based on unspent GP. Currently: *"+format(this.effect())},
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e122)
        if (player.g.base.eq(10))return new Decimal(1e100)
        if (player.g.base.eq(9))return new Decimal(1e33)
        return new Decimal(1e5).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,14) || player.g.base.lte(10)},
      effect(){
    ...
    16:{
      ...
      description(){return "Boost your autoclickers based on unspent GP. Currently: *"+format(this.effect())},
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e201)
        if (player.g.base.eq(10))return new Decimal(1e110)
        if (player.g.base.eq(9))return new Decimal(1e40)
        return new Decimal(1e6).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,15) || player.g.base.lte(10)},
      effect(){
    ...
    17:{
      ...
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e210)
        if (player.g.base.eq(10))return new Decimal(1e120)
        if (player.g.base.eq(9))return new Decimal(1e42)
        return new Decimal(1e7).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return hasUpgrade(this.layer,16) || player.g.base.lte(10)},
      effect(){
    ...
    21:{
      ...
      cost(){
        if (player.g.base.eq(11))return new Decimal(1e220)
        if (player.g.base.eq(10))return new Decimal(1e111)
        return new Decimal(1)
      },
      unlocked(){return hasUpgrade(this.layer,17) || player.g.base.lte(10)},
    ...
    23:{
      ...
      cost(){
        if (player.g.base.eq(10))return new Decimal(1e130)
        if (player.g.base.eq(9))return new Decimal(1e50)
        return new Decimal(1e8).pow(inChallenge("b",31)?10:1)
      },
      unlocked(){return player.g.base.lte(9) || (player.g.base.lte(10)&&hasUpgrade("g",17))}
    },
    24:{
      title: "The Difficulty",
      description(){return "Unlock challenges"},
      cost(){
        if (player.g.base.eq(9) && !player.g.challengeUnlock)return new Decimal(1e110)
        return new Decimal(0)
      },
      unlocked(){return (player.g.base.lte(8) || (player.g.base.lte(9)&&hasUpgrade("g",23))) && !player.g.challengeUnlock},
      onPurchase(){
    ...
    25:{
      ...
      unlocked(){return player.g.base.lte(8) && !player.g.incrementyUnlock},
      onPurchase(){
  ...
  milestones:{
    0: {
      requirementDescription: "Base 7",
        ...
        done() { return player.g.base.lte(7) },
    ...
    7: {
      requirementDescription: "Base 4",
        effectDescription: "Unlock sluggish milestones",
        done() { return player.g.base.lte(4) },
      unlocked(){return hasMilestone(this.layer, this.id-1)}
    },
  },
  dynamicCap(){
